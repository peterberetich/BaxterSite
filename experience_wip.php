...
<div class="col-lg-10">
    ...
    <div class="col-sm-4">
        <div class="card" style="width:100%">
            <a class=baxtitutionpopup_open href="">
            <div class="card-image">
    ...
    <div class="col-sm-4">
        <div class="card" style="width:100%">
            <a class=studentgovpopup_open href="">
            <div class="card-image">
...
<div class="col-lg-10">
    <div class="col-sm-4">
        <div class="card" style="width:100%">
            <a class="opencampuspopup_open" href="">
            <div class="card-image">
    ...
    <div class="col-sm-4">
        <div class="card" style="width:100%">
            <a class=flexfridaypopup_open href="">
            <div class="card-image">
...
<div id="slide" style="background-color:white; width:80%">
<div style="position:relative; float:left; margin: 10px 10px"><button class="btn btn-default faqpopup_close"><span class="glyphicon glyphicon-arrow-left"></span></button></div>
<section id="history">
...
<div id="baxtitutionpopup" style="background-color:white; width:100%">
<div style="position:relative; float:left; margin: 10px 10px"><button class="btn btn-default baxtitutionpopup_close"><span class="glyphicon glyphicon-arrow-left"></span></button></div>
<section id="history">
    <h2 class="fullwidthhistory">Baxtitution</h2>
</section>
<div class="centered1000">
<img class="img-responsive" width="100%" src="documents/Baxtitution.png">
</div>
</div>

<div id="studentgovpopup" style="background-color:white; width:100%">
<div style="position:relative; float:left; margin: 10px 10px"><button class="btn btn-default studentgovpopup_close"><span class="glyphicon glyphicon-arrow-left"></span></button></div>
<section id="history">
...
<div id="opencampuspopup" style="background-color:white; width:100%">
<div style="position:relative; float:left; margin: 10px 10px"><button class="btn btn-default opencampuspopup_close"><span class="glyphicon glyphicon-arrow-left"></span></button></div>
<section id="history">
...
<div class="panel panel-default">
    ...
    <div id="collapse1" class="panel-collapse collapse out">
      <div class="panel-body">
        <object data='documents/OpenCampusContract.pdf#view=FitH'
                type='application/pdf'
...
<div id="flexfridaypopup" style="background-color:white; width:100%">
<div style="position:relative; float:left; margin: 10px 10px"><button class="btn btn-default flexfridaypopup_close"><span class="glyphicon glyphicon-arrow-left"></span></button></div>
<section id="history">
...
<script src="js/jquery.popupoverlay.js"></script>
  ...
  <script>
    $(document).ready(function() {
      ...
      // Initialize the plugin
      $('#baxtitutionpopup').popup({
        opacity: 0.5,
        transition: 'all 0.5s'
      });
      // Initialize the plugin
      $('#studentgovpopup').popup({
        opacity: 0.5,
        transition: 'all 0.5s'
      });
      // Initialize the plugin
      $('#opencampuspopup').popup({
        opacity: 0.5,
        transition: 'all 0.5s'
      });
      // Initialize the plugin
      $('#flexfridaypopup').popup({
        opacity: 0.5,
        transition: 'all 0.5s'
      });
