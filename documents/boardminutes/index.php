...
//
$_CONFIG['main_title'] = "Board Agenda and Minutes";
...
//
$_CONFIG['hidden_files'] = array(".ftpsync_settings", ".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd");
...
<link rel="icon" type="image/png" href="/baxteracademy/images/favicon/baxicon.png">
